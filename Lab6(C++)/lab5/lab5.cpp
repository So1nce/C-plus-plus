...
int __stdcall wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
    ...
    tbButtons[0] = { MAKELONG(indexRectangle,  ImageListID), OBJECTRECTANGLE,  TBSTATE_ENABLED, buttonStyles,
        {0}, 0, (INT_PTR)L"Прямокутник" }; 
    tbButtons[1] = { MAKELONG(indexEllipse,  ImageListID), OBJECTELLIPSE,  TBSTATE_ENABLED, buttonStyles,
        {0}, 0, (INT_PTR)L"Еліпс" }; 
    tbButtons[2] = { MAKELONG(indexLine, ImageListID), OBJECTLINE, TBSTATE_ENABLED, buttonStyles,
        {0}, 0, (INT_PTR)L"Лінія" }; 
    tbButtons[3] = { MAKELONG(indexPoint, ImageListID), OBJECTPOINT, TBSTATE_ENABLED, buttonStyles,
        {0}, 0, (INT_PTR)L"Точка" }; 
